...
# 2.1.204; docs/tmux-backend.md "Incident (2026-07-09)"). Without NBSP
# normalization the glyph-only idle row read pending forever - the false
# "Enter swallowed" class of failures.
